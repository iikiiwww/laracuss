            ...
            <div class="row justify-content-center">
                <div class="col-12 col-lg-3">
                    <a href="" class="nav-link mb-5 text-center">
                        <img class="h-32px" src="{{ url('assets/images/RifkiStore.png')}}" alt="ML">
                    </a>
                    <div class="card mb-5">
                         <form action="">
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="password" class="form-control border-end-0 pe-0 rounded-0 rounded-star" 
                                    id="password" name="password">
                                    <span class="input-group-text bg-white border-start-0 pe-auto">
                                        <a href="javascript:;" id="password-toggle">
                                            <img src="{{ url('assets/images/mata.png')}}" alt="password toggle" id="password-toggle-img">
                                        </a>
                                    </span>
                                </div>
                            </div>
                    ...
                    <div class="text-center">
                        Dont't have account ? <a href="#" class="text-underline"><u>sign up</u></a>
                    </div>
                </div>
            </div>
        </div>
...
@section('after-script')
    <script>
        ...
        $('#password-toggle').on('click', function(){
            ...
            $('#password-toggle-img').attr('src', "{{ url('assets/images/mata.png') }}");
